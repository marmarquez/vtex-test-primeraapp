...
const int pot AjusteFuerzaFrenada =A5; // Para que el freno primario responda mas o menos al pedal secundario. Es un ajuste de pendiente de una recta. si la frenada deseada es "y" y depende del pedal que es "x"  y= a + bx. Este pot ajusta b y el anterior ajusta a. 
